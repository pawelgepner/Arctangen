...
#define biti (2)   //4 bity całkowite i 28 bitów ułamkowych, zakres -8,8
#define bitf (30)  //4 bity całkowite i 28 bitów ułamkowych, zakres -8,8

const double bf = 1073741824; //1 << bitf;
